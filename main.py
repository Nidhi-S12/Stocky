        ...
        try:
            ...
            with st.expander("📋 Data Summary"):
                ...
                with col2:
                    ...
                    st.write(f"• Highest: {currency_symbol}{stock_data['High'].max():.2f}")
                    st.write(f"• Lowest: {currency_symbol}{stock_data['Low'].min():.2f}")
                    st.write(f"• Average: {currency_symbol}{stock_data['Close'].mean():.2f}")
                with col3:
                    st.write("**Model Info**")
